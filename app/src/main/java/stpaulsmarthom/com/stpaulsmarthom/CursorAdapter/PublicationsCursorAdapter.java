...
public class PublicationsCursorAdapter extends CursorAdapter {
    private SparseBooleanArray mSelectedItemsIds;
    public TextView parish_item_name;
    LinearLayout parish_item_pdf;
    Context mContext;

    public PublicationsCursorAdapter(Context context, Cursor c) {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        final int pdfNameIndex = cursor.getColumnIndex(DbContract.DbEntry.PUBLICATIONS_PDF_NAME);
        final int pdfPathIndex = cursor.getColumnIndex(DbContract.DbEntry.PUBLICATIONS_PDF_PATH);

        final int pdfIndex = cursor.getColumnIndex(DbContract.DbEntry.PUBLICATIONS_PDF_IMAGE);
        ...
        parish_item_pdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SharedPreferences preferences = context.getSharedPreferences("PdfPref",Context.MODE_PRIVATE);
